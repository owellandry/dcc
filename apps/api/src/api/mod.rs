...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(
            ...
            post(users::prepare_two_factor),
        )
        .route(
            "/users/@me/two-factor/enable",
            post(users::enable_two_factor),
        )
        .route(
        ...
        .route(
            "/categories/:id/overwrites",
            put(servers::replace_category_overwrites),
        )
        .route(
            "/roles/:id",
